...
?>
<div class="container-fluid py-5" style=" background-image: url(<?= base_url('images/japan_header_background1.webp') ?>);  background-position: 265px 25%; background-size: 100%;">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-7 col-md-12 text-center">
        ...
        <div class="position-relative">
          ...
          <img src="<?= base_url('images/japan_header_object.webp') ?>"
                    ...
                    <div class="col-md-4">
                      <select class="form-select" id="dest_country" name="origin_country" required>
                        ...
                        <?php foreach ($countries as $ct): ?>
                          ...
                          <option <?= $ct['code'] === 'JP' ? 'selected' : '' ?> value="<?= esc($ct['code']) ?>" ?>
                            <?= esc($ct['name']) ?>
                          </option>
                        <?php endforeach; ?>
                      </select>
