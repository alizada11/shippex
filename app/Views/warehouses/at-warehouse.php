    ...
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
        ...
        <p>
          ...
          Unlock US Amazon international
          shipping or shop from Nike US,
          Adidas, Zappos,
          Target, Best Buy and
          Walmart.
        </p>
                    ...
                    <div class="col-md-4">
                      <select class="form-select" id="dest_country" name="origin_country" required>
                        ...
                        <?php foreach ($countries as $ct): ?>
                          ...
                          <option <?= $ct['code'] === 'AT' ? 'selected' : '' ?> value="<?= esc($ct['code']) ?>" ?>
                            <?= esc($ct['name']) ?>
                          </option>
                        <?php endforeach; ?>
                      </select>
...
<div class="container py-5">
  <div class="row justify-content-center">
    <div class="col-12 col-lg-10 text-center">
      ...
      <a href="<?= base_url('/services') ?>" class="btn btn-primary btn-lg">START SHOPPING NOW</a>
    </div>
  </div>
</div>
