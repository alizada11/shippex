    ...
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <div class="page-title-section">
          <h4 class="page-title fw-700"><i class="fas fa-warehouse me-2 text-white"></i> Our Warehouse Locations</h4>
                ...
                <div class="row g-4">
                  <div class="col-6">
                    <div class="info-item">
                      ...
                      <div>
                        <h6 class="text-shippex-primary mb-2">Address Line 1</h6>
                        <p class="mb-1"><?= esc($wh['address_line_1']) ?></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="info-item">
                      ...
                      <div>
                        <h6 class="text-shippex-primary mb-2">Address Line 2</h6>
                        <p class="mb-1"><?= esc($wh['address_line_2']) ?></p>
                  ...
                  <div class="col-6">
                    <div class="info-item">
                      ...
                      <div>
                        <h6 class="text-shippex-primary mb-2">State</h6>
                        <p class="mb-1"><?= esc($wh['state']) ?></p>
                  ...
                  <div class="col-6">
                    <div class="info-item">
                      ...
                      <div>
                        <h6 class="text-shippex-primary mb-2">Postal Code</h6>
                        <p class="mb-1"><?= esc($wh['postal_code']) ?></p>
              ...
              <div class="col-md-5">
                ...
                <div class="action-buttons">
                  <div class="d-grid ">
                    ...
                    if ($request): ?>
                      <a class="btn btn-outline-shippex-primary mb-3">
