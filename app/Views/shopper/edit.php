...
<div class="container py-4">
 ...
 <div class="card">
  <div class="card-body">
   ...
   <div class="form-group row border-top border-bottom py-2">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-8 col-md-9">
     <input name="delivery_description" class="form-control" value="<?= esc($request['delivery_description']) ?>">
    </div>
   </div>
   ...
   <div class="row">
    <div class="col-sm-6 col-md-4">
     <button type="submit" class="btn btn-block btn-secondary text-uppercase">Update Request</button>
    </div>
   </div>
